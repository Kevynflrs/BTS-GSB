...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 10 mars 2025 à 14:48
...
CREATE TABLE IF NOT EXISTS `compte_rendu` (
  ...
  `LieuRapport` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `delegue` (
  `Id_Delegue` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `echantillon` (
  ...
  `ProduitEchantillon` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `practicien` (
  ...
  `NumeroTelephoneMedecin` decimal(10,2) DEFAULT NULL,
  `MailMedecin` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
